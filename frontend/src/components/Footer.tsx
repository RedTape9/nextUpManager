            ...
            <Container>
                <Row>
                    <Col>
                        ...
                        <p className="fs-6">favicon by <a href="https://favicon.io/emoji-favicons/man-surfing" target="_blank" rel="noopener noreferrer" className="text-white">favicon.io</a> (no changes made)</p>
                    </Col>
                </Row>
            </Container>
        </footer>
